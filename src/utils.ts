...
const unicodeWordMatch =
  // trunk-ignore(eslint/unicorn/no-hex-escape,eslint/optimize-regex/optimize-regex)
...
export function titlecase(text: string): string | undefined {
  ...
  if (typeof text !== 'string') {
    throw new TypeError('invalid argument provided to titlecase()');
  }
  return text.replace(
...
export function prefixParser(text: string | undefined): string | undefined {
  if (!text) return undefined;
  if (typeof text !== 'string') {
    throw new TypeError('invalid argument provided to prefixParser()');
  }
